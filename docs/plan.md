...
```toml
ikpir-common = { git = "https://github.com/bao-ninh-orochi/IKPIR", rev = "0f3b99b" }   # perf/optimized tip
```
...
workspace's pinned IKPIR `perf/optimized` rev (`0f3b99b`); see that file's "IKPIR build"
